...
<!--
  ...
  for a ranges-only document, yet FieldWorks/WeSay write them routinely. The
  <define> blocks below are copied verbatim from lift-0.13.rng (see
  PROVENANCE.md in this directory) so the content model is exactly the spec's;
  only the <lift-ranges> root is new.
-->
"""
