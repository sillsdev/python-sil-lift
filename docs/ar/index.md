...
مكتبة لغة بايثون لـ [LIFT](https://github.com/sillsdev/lift-standard) (تنسيق تبادل المعاجم) الإصدار 0.13: قراءة وكتابة ملفات مجلد LIFT دون فقدان البيانات (`.lift` + `.lift-ranges` + مراجع الوسائط)، والتحقق من صحة المخطط الدلالي والمعاني، والفرز القياسي — مع واجهات برمجة تطبيقات (API) للتدفق المباشر للمعاجم الكبيرة.
