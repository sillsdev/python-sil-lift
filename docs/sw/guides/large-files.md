...
- Wala haizalishi alama za muda, kama [`Lexicon.save()`](../fidelity.md#saving-an-edited-document) inavyofanya. Kuingia kunandikwa pamoja na tarehe zake: pasi ya mtiririko haioni kamwe hati kama ilivyokuwa, hivyo haiwezi kuonyesha ni maingizo gani uliyobadilisha. Weka `entry.date_modified` mwenyewe kwenye zile ambazo toleo hili linazirekebisha.
