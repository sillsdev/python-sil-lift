...
[LIFT](https://github.com/sillsdev/lift-standard) (लेक्सिकन इंटरचेंज फॉर्मेट) 0.13 के लिए एक पाइथन लाइब्रेरी: LIFT फ़ोल्डर (`.lift` + `.lift-ranges` + मीडिया संदर्भ) का बिना हानि के रीड/राइट, स्कीमा और सेमांटिक सत्यापन, तथा कैनोनिकल सॉर्टिंग — बड़े लेक्सिकन के लिए स्ट्रीमिंग एपीआई के साथ।
