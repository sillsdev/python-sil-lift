...
एक उम्मीदवार जिसे `<lift-ranges>` दस्तावेज़ के रूप में नहीं पढ़ा जा सकता (जैसे, एक रुका हुआ निर्यात से शून्य-बाइट फ़ाइल) को लोड विफल करने के बजाय छोड़ दिया जाता है, और इसे [`unreadable-ranges-file`](validate.md#problem-codes) के रूप में रिपोर्ट किया जाता है। `RangesFile.load()` के साथ सीधे लोड करने पर इसके बजाय त्रुटि उत्पन्न होती है।
