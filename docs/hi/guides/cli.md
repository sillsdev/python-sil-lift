...
`validate`, `stats`, `check-media`, और `export` एक ज़िप किए गए LIFT पैकेज को भी स्वीकार करते हैं (दोनों लेआउट में एक `.zip` — आर्काइव रूट में फ़ाइलें, या एक टॉप-लेवल फ़ोल्डर के अंदर); इसे एक अस्थायी निर्देशिका में निकाला जाता है और कमांड समाप्त होने पर हटा दिया जाता है। स्ट्रीमिंग कमांड्स `stats` और `export` केवल `.lift` को ही एक्सट्रेक्ट करते हैं, इसलिए ये मीडिया-भारी पैकेजों पर सस्ते पड़ते हैं; `validate` और `check-media` को पूरे फ़ोल्डर की ज़रूरत होती है और वे सब कुछ एक्सट्रेक्ट करते हैं।
...
सभी आउटपुट हर प्लेटफ़ॉर्म पर UTF-8 में होता है, चाहे वह कंसोल हो, पाइप हो, या `>` रीडायरेक्ट — कभी भी लोकल एन्कोडिंग (Windows पर cp1252, C/POSIX लोकल में ASCII) नहीं, क्योंकि यह LIFT सामग्री का प्रतिनिधित्व नहीं कर सकता। `sil-lift export dictionary.lift > dictionary.csv` इसलिए बिल्कुल वही बाइट्स लिखता है जो `-o dictionary.csv` लिखता है, जिसमें CRLF पंक्ति समाप्ति चिह्न भी शामिल हैं।

एग्जिट कोड: `0` सफलता (चेतावनियाँ अनुमत हैं, जब तक कि `--strict` न हो), `1` निष्कर्ष (सत्यापन त्रुटियाँ / अनुपस्थित मीडिया / `--strict` के तहत चेतावनियाँ), `2` किसी भी छोर पर I/O विफलता — इनपुट जिसे पढ़ा नहीं जा सकता, या आउटपुट जिसे लिखा नहीं जा सकता (जैसे `head` जैसा रीडर पाइप बंद कर रहा हो, डिस्क भर जाने के कारण)।
