...
Библиотека Python для [LIFT](https://github.com/sillsdev/lift-standard) (Lexicon Interchange Format) версии 0.13: чтение и запись папки LIFT без потерь (файлы `.lift`, `.lift-ranges` и ссылки на медиафайлы), проверка соответствия схеме и семантике, а также каноническая сортировка — с потоковыми API для больших лексиконов.
